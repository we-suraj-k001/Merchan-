    ...
    <div class="col-6" >
        ...
        <Panel class="is-small" v-if="store && store.item">
            ...
            <template #icons>
                ...
                <div class="p-inputgroup">
                    <Button label="Edit"
                            ...
                            data-testid="channels-item-to-edit"
                            icon="pi pi-save"/>
                    ...
                    <Button
                        ...
                        data-testid="channels-item-menu"
                    ...
                    <Button class="p-button-primary p-button-sm"
                            icon="pi pi-times"
                            data-testid="channels-item-to-list"
                            @click="store.toList()"/>
            ...
            <div class="mt-2" v-if="store.item">
                ...
                <Message severity="info" :closable="false" v-if="store.item.note">
                    <tr>

                        <td  colspan="2" >
                            <div class="word-overflow">
                                {{store.item.note.notes}}</div>
                        </td>
                    </tr>
                </Message>
                    ...
                    <div class="flex align-items-center justify-content-between">
                        ...
                        <div class="ml-3">
                            <Button label="Restore"
                                    class="p-button-sm"
                                    data-testid="channels-item-restore"
                ...
                <table class="p-datatable-table">
                    ...
                    <template v-for="(value, column) in store.item ">
                        ...
                        column === 'mer_customer_id' || column === 'note' || column === 'notes'">
                        </template>
